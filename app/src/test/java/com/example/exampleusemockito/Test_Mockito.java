package com.example.exampleusemockito;
...
import com.example.exampleusemockito.Calculator;
import com.example.exampleusemockito.ICalculator;
...
//	ICalculator mcalc = Mockito.mock(ICalculator.class);
    ...
    public void testCalcAdd() {
        ...
        Mockito.when(calc.add(10.0, 20.0)).thenReturn(30.0);
    ...
    public void testCallMethod() {
        ...
        org.junit.Assert.assertEquals(calc.subtract(15.0, 25.0), 10, 0);
